...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $proeficiencia = $_POST['proeficiencia'];

    // Inserir dados na tabela competencia
    $sql_insert = "INSERT INTO competencia (id_cozinheiro, nome, descricao, proeficiencia) VALUES (:id_cozinheiro, :nome, :descricao, :proeficiencia)";
    ...
    $stmt_insert->bindParam(':proeficiencia', $proeficiencia);
    ...
    <div class="container">
        ...
        <form method="POST" action="">
            ...
            <div class="form-group">
                ...
                <input type="number" id="proef" name="proeficiencia" min="1" max="10" required>
            </div>
